...
../../tools/gbdt/gbdt -t 30 -s 1 te.gbdt.dense te.gbdt.sparse tr.gbdt.dense tr.gbdt.sparse te.gbdt.out tr.gbdt.out
python ./converters/pre-b.py tr.csv tr.gbdt.out tr.ffm
python ./converters/pre-b.py te.csv te.gbdt.out te.ffm
../../tools/libffm-1.13/ffm-train -k 4 -t 18 -s 1 -p te.ffm tr.ffm model
../../tools/libffm-1.13/ffm-predict te.ffm model te.out
